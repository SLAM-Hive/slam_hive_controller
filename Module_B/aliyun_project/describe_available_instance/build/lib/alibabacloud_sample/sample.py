...
class Sample:
    ...
    def main(
        ...
        resp = client.describe_available_resource_with_options(describe_available_resource_request, runtime)
    ...
    async def main_async(
        ...
        runtime = util_models.RuntimeOptions()
        resp = await client.describe_available_resource_with_options_async(describe_available_resource_request, runtime)
        ConsoleClient.log(UtilClient.to_jsonstring(resp))
